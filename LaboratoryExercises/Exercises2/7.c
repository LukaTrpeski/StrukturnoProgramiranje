...
int main()
{
    ...
    if(godina%400==0 || godina%4==0 && godina%100!=0 && mesec==02 && den==29)
    {
        printf("DA");
    }
    else if(mesec==02 && den<=28)
    {
        printf("DA");
    }
    else if((mesec==1 || mesec==3 || mesec==5 || mesec==7 || mesec==8 || mesec==10 || mesec==12)&& den<=31)
    {
        printf("DA");
    }
